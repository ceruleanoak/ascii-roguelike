...
export class RoomGenerator {
  ...
  generateRoom(type = null, playerStartPos = null) {
  ...
  generateCombatRoom(room) {
    // Spawn 1-5 enemies based on depth
    const enemyCount = Math.min(1 + Math.floor(this.currentDepth / 3), 5);
    ...
    // Exits appear after all enemies defeated
