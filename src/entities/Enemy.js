...
export class Enemy {
   ...
   */
  // Line-of-sight waypoint pathfinding — moved to EnemyPathfinding.js to
  // stay under this file's architecture budget.
  computeNodePath(targetPos, allowFlip = false) {
    computeNodePathImpl(this, targetPos, allowFlip);
  }
